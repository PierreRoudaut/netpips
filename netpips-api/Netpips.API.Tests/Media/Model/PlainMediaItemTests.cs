...
{
    Mock<IOptions<NetpipsSettings>> _settings;
    ...
    public void CtorTest()
    {
        ...
        Assert.Throws<InvalidOperationException>(() => new PlainMediaItem(new DirectoryInfo(_settings.Object.Value.MediaLibraryPath), _settings.Object.Value.MediaLibraryPath));
        var item = new PlainMediaItem(fileInfo, _settings.Object.Value.MediaLibraryPath);
        Assert.NotNull(item);
    ...
    public void RenameTest()
    {
        ...
        var rootMediaFolder = new PlainMediaItem(new DirectoryInfo(Path.Combine(_settings.Object.Value.MediaLibraryPath, "Movies")), _settings.Object.Value.MediaLibraryPath);
