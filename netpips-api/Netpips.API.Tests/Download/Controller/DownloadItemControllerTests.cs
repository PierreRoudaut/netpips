...
public class DownloadItemControllerTest
{
    ...
    private Mock<ILogger<DownloadItemController>> _logger;
    ...
    public void Setup()
    {
        _logger = new Mock<ILogger<DownloadItemController>>();
    ...
    public void ListTest()
    {
        ...
        var controller = new DownloadItemController(_logger.Object, _service.Object, _authorizationService.Object, _repository.Object);
    ...
    public void StartTestTestDuplicateDownload()
    {
        ...
        _repository.Setup(x => x.FindAllUnarchived())
    ...
    {
        _service.Setup(x => x.StartDownload(It.IsAny<DownloadItem>(), out error)).Returns(false);

        var controller = new DownloadItemController(_logger.Object, _service.Object, _authorizationService.Object,
            _repository.Object)
        {
    ...
    public void StartTestOk()
    {
        ...
        _service.Setup(x => x.StartDownload(item, out error)).Returns(true);
        var controller = new DownloadItemController(_logger.Object, _service.Object, _authorizationService.Object, _repository.Object)
        {
            ControllerContext = new ControllerContext
            {
    ...
    {
        _repository.Setup(x => x.Find(It.IsAny<string>())).Returns((DownloadItem)null);
    ...
    public void CancelTestCaseUnauthorized()
    {
        ...
        _repository.Setup(x => x.Find(It.IsAny<string>())).Returns(item);
    ...
    {
        var item = new DownloadItem();
        _service.Setup(x => x.CancelDownload(item));
        _repository.Setup(x => x.Find(It.IsAny<string>())).Returns(item);
        ...
        _service.Verify(x => x.CancelDownload(item), Times.Once);
    ...
    public void ArchiveTestCaseOk()
    {
        ...
        _service.Verify(x => x.ArchiveDownload(item), Times.Once);
