...
{
    private readonly ILogger<MagnetDlScrapper> _logger;
    private static readonly Uri BaseUri = new("https://www.magnetdl.com");
    private static readonly Uri TorrentDetailPrefixUri = new(BaseUri, "file");
