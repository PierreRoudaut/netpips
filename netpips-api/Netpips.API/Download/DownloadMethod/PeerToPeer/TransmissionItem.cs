...
{
    private readonly string _summaryStats;

    private readonly string _fullStats;

    public TransmissionItem(string summaryStats, string fullStats)
    {
        _summaryStats = summaryStats;
        _fullStats = fullStats;
    }
    ...
    public string ParseStandardValue(string property)
    {
        ...
        var match = new Regex(standardPattern).Match(_summaryStats);
    ...
    public long TotalSize
    {
        get
        {
            ...
            var match = new Regex(format).Match(_summaryStats);
    ...
    public int Peers
    {
        get
        {
            ...
            var match = new Regex(pattern).Match(_summaryStats);
    ...
    public List<File> Files
    {
        get
        {
            ...
            var matchs = new Regex(pattern).Matches(_fullStats).ToList();
            matchs.ForEach(m =>
            {
